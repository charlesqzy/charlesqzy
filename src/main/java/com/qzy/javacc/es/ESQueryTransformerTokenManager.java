/* ESQueryTransformerTokenManager.java */
/* Generated By:JavaCC: Do not edit this line. ESQueryTransformerTokenManager.java */
...
public class ESQueryTransformerTokenManager implements ESQueryTransformerConstants {
...
static final int[] jjnextStates = {
   57, 59, 51, 53, 46, 47, 43, 44, 37, 38, 40, 41, 
};
...
private void jjCheckNAddTwoStates(int state1, int state2)
{
   ...
   jjCheckNAdd(state2);
    ...
    /** Constructor. */
    public ESQueryTransformerTokenManager(SimpleCharStream stream){
  ...
  /** Constructor. */
  public ESQueryTransformerTokenManager (SimpleCharStream stream, int lexState){
    ReInit(stream);
    SwitchTo(lexState);
  }
